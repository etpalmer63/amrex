...
if (AMReX_HYPRE)
    ...
    cmake_path(GET HYPRE_DIR PARENT_PATH HYPRE_ROOT)
    cmake_path(GET HYPRE_ROOT PARENT_PATH HYPRE_ROOT)
    cmake_path(GET HYPRE_ROOT PARENT_PATH HYPRE_ROOT)
    message("STATUS Found Hypre=${HYPRE_ROOT}")
    #set(HYPRE_LIBRARIES ${HYPRE_ROOT}/lib)
    set(HYPRE_INCLUDE_DIRS ${HYPRE_ROOT}/include)
    message("-->  ${HYPRE_LIBRARIES} ${HYPRE_INCLUDE_DIRS}")
    target_link_libraries(amrex PUBLIC HYPRE::HYPRE)
    target_include_directories(amrex PUBLIC ${HYPRE_INCLUDE_DIRS} )
endif ()
